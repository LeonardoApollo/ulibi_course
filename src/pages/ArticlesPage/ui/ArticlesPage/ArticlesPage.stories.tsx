...
PrimaryGRID.args = {};
PrimaryGRID.decorators = [
    StoreDecorator({
        articlesPage,
    }),
];

export const PrimaryGRIDRedesigned = Template.bind({});
PrimaryGRIDRedesigned.args = {};
PrimaryGRIDRedesigned.decorators = [
    NewDesignDecorator,
    StoreDecorator({
        articlesPage,
    }),
...
PrimaryList.decorators = [
    StoreDecorator({
        articlesPage: articlesPageList,
    }),
];

export const PrimaryListRedesigned = Template.bind({});
PrimaryListRedesigned.args = {};
PrimaryListRedesigned.decorators = [
    NewDesignDecorator,
    StoreDecorator({
        articlesPage: articlesPageList,
    }),
